package com.projects.brightcreations.moviesappmvp.SQLiteDataBase;
...
public class MoviesDB {
    ...
    public void addMovie(String id, String tittle, String over_view , String vote_average, String date,
        ...
        values.put(contract.COLUMN_MOVIE_BACKDROP_PATH, backdrop_path);
    ...
    public ArrayList<Object> getOneMovie(long ID) {
        ...
        cursor = db.query(
                contract.TABLE_NAME,
                new String[] { contract.COLUMN_MOVIE_ID, contract.COLUMN_MOVIE_TITTLE,
                        contract.COLUMN_MOVIE_OVERVIEW, contract.COLUMN_MOVIE_VOTE_AVERAGE,
                        contract.COLUMN_MOVIE_DATE, contract.COLUMN_MOVIE_POSTERPATH,
                        contract.COLUMN_MOVIE_BACKDROP_PATH},
